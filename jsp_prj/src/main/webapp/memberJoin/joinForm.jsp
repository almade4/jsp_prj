...
$(function(){
	$("#duplicateButton").click(function(){
		...
		window.open(openPage,"idDupWin","width=474,height=374,top="+(window.screenY+300)+",left="+(window.screenX+400));
	});
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input class="member-input" type="text" id="name" name="name"
                                   maxlength="30" autocomplete="name" value="test"></td>
                    </tr>
                    <tr>
                        ...
                        <td><input class="member-input" type="email" id="email" name="email"
                                   maxlength="100" autocomplete="email" placeholder="example@ballpick.com" value="test@test.com"></td>
                    </tr>
                    <tr>
