...
<h2>GET방식 요청</h2>
<ul>
	<li>링크 : <a href="requestB.jsp"></a>요청</li>
	...
	<li>form 태그
		...
		<!-- button 태그가 form 태그의 자식으로 정의되면 자동 submit이 된다 -->
...
<div id="post">
<h2>POST방식 요청</h2>
		<form action="requestB.jsp" method="POST" id="postFrm" onsubmit="return false;"></form>
		<label>아무말</label><input type="text" name="txt" id="txt"><br>
		<!-- button 태그가 form 태그의 자식으로 정의되면 자동 submit이 된다 -->
		<button class="btn btn-outline-primary btn-sm" id="btn3">요청</button>
		<!-- button 태그가 form 태그의 자식으로 정의되면 자동 submit이 안된다 -->
