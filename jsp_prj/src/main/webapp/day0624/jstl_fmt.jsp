		...
		<div class="col">
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              ...
              가격 : <span style="text-decoration: line-through;"><fmt:formatNumber value="${prd.price }" pattern="#,###,###"/></span>원 =&gt;
              <fmt:formatNumber value="${prd.price }" pattern="#,###,###"/>원</p>
              <div class="d-flex justify-content-between align-items-center">
                ...
                <fmt:formatDate value="${prd.inputDate }" pattern="MM-dd-yyyy EEEE a"/>
				</small>
              </div>
            </div>
          </div>
