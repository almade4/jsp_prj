...
function useJSON(){
	...
	$.ajax({
		...
		success : function(jsonObj){
			...
			//JSONObject안에 JSONArray를 parsing하여 반복시켜 JSONArray안에
...
<body>
	...
	<main>
		<div>
			...
			<input type="button" value="QueryString형식"
					class="btn btn-sm btn-info" id="btnQueryString"/>
			<input type="button" value="JSONObject형식"
					class="btn btn-sm btn-primary" id="btnJSON"/>
