  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				...
				log(String.valueOf(cookies.length));
				%>
				
				<form action="whySessionB.jsp" method="GET">
				<label>이름</label>
				<input type="text" name="name" id="id"/>
				<br>
				<button class="btn btn-success btn-sm">입력</button>
				</form>
				</div>
				<div class="col-md-5">
		...
		<footer class="container">
			...
			<p>
				&copy; class2 &middot; <a href="#">Privacy</a>
